...
**Opis:**  
Aplikacja służy do szacowania sukcesu utworu muzycznego na platformie Spotify z pomocą regresji liniowej, na podstawie zebranych danych dotyczących utworów i artystów. Wynik wyliczany jest w skali 0-100, gdzie 100 oznacza największą popularność. Model może być wykorzystywany przez wytwórnie w celu oceny potencjalnej inwestycji w artystę lub przez muzyków do optymalizacji działań promocyjnych.
...
- **Opis:** Użytkownik wprowadza dane liczbowe dotyczące miesięcznych słuchaczy na Spotify, obserwujących na Instagramie i Spotify, subskrybentów na YouTube i polubień na TikToku.  
- **Priorytet:** 1  
...
- **Opis:** Po naciśnięciu przycisku „Oblicz”, system wykonuje obliczenia wykorzystując model regresji i generuje prognozowany wynik.  
- **Priorytet:** 1  
...
- **Opis:** System wyświetla wynik w skali 0-100 oraz kategorię słowną:  
  - 0–20: „Bardzo słaby wynik”  
  - 21–40: „Słaby wynik”  
  - 41–60: „Satysfakcjonujący wynik”  
  - 61–80: „Dobry wynik”  
  - 81–100: „Świetny wynik”  
  Wyświetlany jest również odpowiedni plik GIF w zależności od kategorii wyniku.  
- **Priorytet:** 1  
...
- **Opis:** System pokazuje pasek ładowania, a następnie animację balonów sygnalizując zakończenie obliczeń.  
- **Priorytet:** 3  
...
- **Pliki:**  
  - `dane.xlsx` (dane pobrane z pomocą [Spotify API](https://developer.spotify.com/documentation/web-api/))  
  - `ikona.png`  
  - `nutki.jpg`  
  - `bardzoslabo.gif`  
  - `slabo.gif`  
...
- **Warunki wstępne:** Uruchomienie aplikacji, poprawne załadowanie pliku `dane.xlsx`  
- **Kroki:**  
  ...
  6. „Polubienia TikTok (wszystkie filmy na profilu) (tyś)”: 100000  
...
- **Rzeczywisty rezultat:**  
  Zgodny z oczekiwanym, wyświetlony wynik: 95  

> Sprawdzenie pozostałych scenariuszy odbywa się analogicznie, zmieniając wartości wejściowe w celu uzyskania innej oceny.
